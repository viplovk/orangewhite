...
export const SPECIFICATIONS: SpecificationItem[] = [
  ...
  {
    parameter: 'ACADEMIC METRIC',
    value: '7.95 SGPA',
    detail: 'Recorded across Semester 01 examination at IEC College of Engineering & Technology',
...
export const EDUCATION_TIMELINE: EducationItem[] = [
  {
    ...
    score: '7.95 SGPA',
    scoreLabel: 'SEMESTER 01 RECORD',
    highlights: [
      'Bachelor of Technology (B.Tech) in Computer Science & Engineering (CSE)',
      'First Semester Academic Performance: 7.95 SGPA',
